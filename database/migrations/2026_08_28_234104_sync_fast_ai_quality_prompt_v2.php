...
return new class extends Migration
{
    ...
    {
        $this->sync($this->promptV20(), '2.0.0');
    }

    public function down(): void
    {
        $this->sync($this->versionedPrompt('article-quality-cn-v1.0.0.txt'), '1.0.0');
    }

    private function promptV20(): string
    {
        $content = str_replace(
            [
            ...
            $this->versionedPrompt('article-quality-cn-v2.2.0.txt'),
        );
    ...
    private function versionedPrompt(string $filename): string
    {
        $content = file_get_contents(resource_path('prompts/versions/'.$filename));
    ...
    private function sync(string $content, string $version): void
    {
